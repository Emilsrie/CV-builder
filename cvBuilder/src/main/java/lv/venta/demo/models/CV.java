...
public class CV {
	...
	public CV(
			@NotEmpty @Size(min = 2, max = 60) @Pattern(regexp = "^[a-zA-Z-āĀčČēĒģĢīĪķĶļĻņŅšŠžŽ\\s]+$", message = "Invalid letters") String name,
			@NotEmpty @Size(min = 2, max = 60) @Pattern(regexp = "^[a-zA-Z-āĀčČēĒģĢīĪķĶļĻņŅšŠžŽ\\s]+$", message = "Invalid letters") String surname,
